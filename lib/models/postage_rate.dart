...
class PostageRate {
  ...
  factory PostageRate.fromJson(Map<String, dynamic> json) {
    // Very defensive parsing to avoid exceptions on missing fields
    final service =
    ...
    return PostageRate(service: service, cost: cost, eta: eta, code: code);
  }
